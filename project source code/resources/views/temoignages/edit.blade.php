	...
	<br/>
        <div class="row">
            ...
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                ...
                <h2 class="widget-header user"><center>Modifier ce temoignage</center></h2>
                {!! Form::open(['route' => ['sindamtemoignage.update',$temoignages->id], 'method' => 'PATCH', 'data-parsley-validate'=>'']) !!}
				
                                     
                                   
                                    <div class="form-group">
                                        {{ Form::label('description', 'Description') }}
                                        {{ Form::textarea('contenue', $temoignages->contenue, array('class' => 'form-control','required'=>'','placeholder'=>'Decrivez ce que vous voulez ?')) }}
                                    </div>
