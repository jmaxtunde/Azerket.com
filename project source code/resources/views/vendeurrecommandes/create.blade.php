    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2"> 
            <div class="widget personal-info">
                    <h2 class="widget-header user"><center> Devenir vendeur recommandé de azerket.com</center></h2>     
              <p>Le payment se fera d'abord par mobile money sur ce numéro + 229 66 33 87 29. D'autres moyens de payements seront disponible très prochainement... Nous vous contacterons aussi par appel téléphonique ou WhatsApp.</p>
                                  {!! Form::open(['route' => 'vendeurrecommandes.store', 'method' => 'POST', 'files' => true, 'data-parsley-validate'=>'']) !!}

                                    
                                    <div class="form-group">
                                        {{ Form::label('Nombre de Mois', 'Nombre de mois') }}
                                        {{ Form::text('nbMois', null, array('class' => 'form-control','required'=>'','placeholder'=>'Nombre de mois')) }}
                                    </div>
