        ...
        <div class="row">
            ...
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
				...
				<div class="widget dashboard-container my-adslist">
						<h3 class="widget-heade"><center> Tous les messages envoyés aux vendeurs </center></h3>
						
						@forelse($messages->chunk(50) as $chunk)
									...
									<div class="">
										<ul class="list-inline justify-content-center">
											...
											<li class="list-inline-item">
												<a data-toggle="tooltip" data-placement="top" title="Supprimer le message" class="delete" href="{{route('message.delete',['id' => $annonce->id]) }}">
