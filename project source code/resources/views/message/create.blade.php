        ...
        <div class="col-md-8 col-md-offset-2"> 
            <div class="widget personal-info">
              @if(Session::has('msg'))
                                ...
                                @endif
                    <h2 class="widget-header user"><center> Envoyez un message </center></h2>        
                                  {!! Form::open(['route' => 'message.store', 'method' => 'POST', 'files' => true, 'data-parsley-validate'=>'']) !!}

                                    
                                    <div class="form-group">
                                        {{ Form::label('message', 'Message') }}
                                        {{ Form::textarea('message', null, array('class' => 'form-control','required'=>'','placeholder'=>'Votre message','id'=>'froala-editor')) }}
                                    </div>
                                        
                                    <div class="form-group">
                                        {{ Form::hidden('pseudo',$user->name) }}
                                    </div>
									<div class="form-group">
                                        {{ Form::hidden('telephone',$user->callPhoneNumber) }}
                                    </div>
									<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        {{ Form::hidden('user_id',$annonces->user_id) }}
                                    </div>
