...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sellers.index',compact('userRecommended'));
    }
    ...
    public function show($id)
    {
        ...
        if(is_numeric($id))
		{
		    $annonces = Annonce::where('statut','Active')->where('user_id',$id)->orderBY('id','desc')->paginate(20);
            $user = Annonce::where('user_id',$id)->get()->take(1);
			 return view('sellers.show', compact('annonces','user'));
